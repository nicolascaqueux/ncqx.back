...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    music_posts: Schema.Attribute.Relation<
      'manyToMany',
      'api::music-post.music-post'
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    photo_posts: Schema.Attribute.Relation<
      'manyToMany',
      'api::photo-post.photo-post'
    >;
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['blog', 'music', 'photo']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMusicPostMusicPost extends Struct.CollectionTypeSchema {
  collectionName: 'music_posts';
  info: {
    displayName: 'Music Post';
    pluralName: 'music-posts';
    singularName: 'music-post';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isAlbum: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::music-post.music-post'
...
export interface ApiPhotoPostPhotoPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    aspect_ratio: Schema.Attribute.Enumeration<['vertical', 'horizontal']> &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::music-post.music-post': ApiMusicPostMusicPost;
